Here’s the **updated Node.js cheatsheet** with a new section on using `migrate-mongo`, written in English and seamlessly integrated into the existing structure:
